...
public abstract class BaseGalleryGroupAdapter<VH extends android.support.v7.widget.RecyclerView.ViewHolder> extends BaseRecyclerAdapter<VH> {
    ...
    public BaseGalleryGroupAdapter(Context context, int spanCount) {
        if (context == null) {
